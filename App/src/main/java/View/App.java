...
public class App extends JFrame {
    ...
    private void handleBuyOptions(JMenuBar menuBar, JPanel panel) throws IOException {
        ...
        comprarOptions.add(new CustomJMenuItem(this, panel, "Vender", new ViewVenderEstoque(client).getContentPane()));
        comprarOptions.add(new CustomJMenuItem(this, panel, "Repor", new ViewCarregarEstoque(client).getContentPane()));
